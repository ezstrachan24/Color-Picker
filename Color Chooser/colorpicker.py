...
class ColorPicker(EasyFrame):
    """Display the results of picking a color."""

    def __init__(self):
        """Sets up teh window and widgets."""
        EasyFrame.__init__(self, title = "Color Chooser Demo")

        # Labels and outouts fields 
        ...
        # Command Button
        self.addButton(text = "Choose a Color", row = 4, column = 0, columnspan = 3, command = self.chooseColor)
